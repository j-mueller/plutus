...
{-# INLINABLE mustPayToScript #-}
-- | Lock the value with a script
mustPayToScript :: forall i o. PlutusTx.IsData o => o -> Value -> TxConstraints i o
mustPayToScript dt vl =
    TxConstraints
...
mustForgeValue :: forall i o. MonetaryPolicyHash -> TokenName -> Integer -> TxConstraints i o
mustForgeValue mps tn = singleton . MustForgeValue mps tn
