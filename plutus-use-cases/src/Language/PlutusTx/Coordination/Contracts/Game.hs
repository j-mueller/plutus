...
lockTrace =
    ...
    Trace.callEndpoint w1 "lock" (LockParams "secret" 10) >> Trace.handleBlockchainEvents w1
...
guessTrace =
    ...
    lockTrace >> Trace.callEndpoint w2 "guess" (GuessParams "secret") >> Trace.handleBlockchainEvents w2
